...
# <img class="header-prefix-icon" :src="$withBase('/cardscript-assets/icons/24dp/action-refresh-watching.svg')" alt="Relevant Cardscript icon">Action.RefreshWatching
