...
* [Github repository](https://github.com/wmfs/tymly-rankings-plugin#readme)
* [NPM package](https://www.npmjs.com/package/@wmfs/tymly-rankings-plugin)
...
| Name | Description |
| ---- | ----------- |
| [rankings](services/rankings.html) | Adds a ranking engine |
