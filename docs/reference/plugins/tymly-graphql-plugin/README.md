...
# tymly-graphql-plugin

::: tip Description
Exposes the Tymly framework via GraphQL.
:::

## Links

* [Github repository](https://github.com/wmfs/tymly-graphql-plugin#readme)
* [NPM package](https://www.npmjs.com/package/@wmfs/tymly-graphql-plugin)
