...
| `/card-templates` | One JSON file per Card | [tymly-users-plugin](plugins/tymly-users-plugin/)|
...
| [stateboxApi](plugins/tymly-graphql-plugin/services/statebox-api.html) | Exposes the core Tymly abilities (start, get, update and cancel) over a JWT-secured REST API using GraphQL |
